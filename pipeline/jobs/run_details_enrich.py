...
def update_detail(conn, ext_id: str, description: str, buyer: str | None) -> None:
    q = """
    ...
    """
    with conn.cursor() as cur:
        cur.execute(q, {"description": description, "buyer": buyer, "external_id": ext_id})
    ...
    with get_conn() as conn:
        ...
        for ext_id in ids:
            try:
                ...
                update_detail(conn, ext_id, d.body_text, d.buyer or d.organismo)
                updated += 1
